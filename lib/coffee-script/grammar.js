...
(function() {
  ...
  grammar = {
    ...
    Statement: [
      o('Assignable TypeAnnotation'), o('Return'), o('Comment'), o('STATEMENT', function() {
    ...
    Assign: [
      o('Assignable OptTypeAnnotation = Expression', function() {
        return new Assign($1, $4, null, null, $2);
      }), o('Assignable OptTypeAnnotation = TERMINATOR Expression', function() {
        return new Assign($1, $5, null, null, $2);
      }), o('Assignable OptTypeAnnotation = INDENT Expression OUTDENT', function() {
        return new Assign($1, $5, null, null, $2);
      })
    ],
    AssignObj: [
    ...
    Type: [o('UnionOrIntersectionOrPrimaryType'), o('FunctionType')],
    ...
    TypeMember: [o('PropertySignature'), o('IndexSignature')],
    PropertySignature: [
      o('PropertyName OptTypeAnnotation', function() {
        return {
     ...
     */
    IndexSignature: [
      o('[ BindingIdentifier TypeAnnotation ] TypeAnnotation', function() {
        return {
          type: "IndexSignature",
          BindingIdentifier: $2,
          IndexType: $3,
     ...
     */
    TypeParameters: [
      o('< TypeParameterList >', function() {
        return $2;
      })
    ],
    TypeParameterList: [
      o('TypeParameter', function() {
        return [$1];
      }), o('TypeParameterList , TypeParameter', function() {
        return $1.concat($3);
      })
    ],
    TypeParameter: [
      o('BindingIdentifier', function() {
        return {
          type: "TypeParameter",
          BindingIdentifier: $1
        };
      }), o('BindingIdentifier EXTENDS Type', function() {
        return {
          type: "TypeParameter",
          Constraint: $3
        };
