...
(function() {
  ...
  grammar = {
     ...
     */
    ParameterList: [
      o('RequiredParameterList', function() {
        return [$1];
      })
    ],
    RequiredParameterList: [
      o('RequiredParameter', function() {
        return [$1];
      }), o('RequiredParameterList , RequiredParameter', function() {
        return $1.concat($3);
      })
    ],
    RequiredParameter: [
      o('BindingIdentifierOrPattern', function() {
        return {
          type: "RequiredParameter",
          BindingIdentifierOrPattern: $1
        };
      })
    ],
