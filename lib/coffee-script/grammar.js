...
(function() {
  ...
  grammar = {
    ...
    Assign: [
      o('Assignable = Expression', function() {
        ...
        return new Assign($1, $4);
      }), o('Assignable TypeAnnotation = Expression', function() {
        return new Assign($1, $4, null, null, $2);
      }), o('Assignable TypeAnnotation = TERMINATOR Expression', function() {
        return new Assign($1, $5, null, null, $2);
      }), o('Assignable TypeAnnotation = INDENT Expression OUTDENT', function() {
        return new Assign($1, $5, null, null, $2);
      })
    ],
    AssignObj: [
      o('ObjAssignable', function() {
        return new Value($1);
      }), o('ObjAssignable TypeAnnotation', function() {
        return new Value($1);
    ...
    Param: [
      ...
      }), o('ParamVar TypeAnnotation', function() {
        return new Param($1, null, null, $2);
      }), o('ParamVar ... TypeAnnotation', function() {
        return new Param($1, null, true, $3);
      }), o('ParamVar TypeAnnotation = Expression', function() {
        return new Param($1, $4, null, $2);
      }), o('...', function() {
    ...
    IdentifierName: [o('IDENTIFIER')],
    IdentifierReference: [o('IDENTIFIER')],
    BindingIdentifier: [o('IDENTIFIER')],
    BindingPattern: [o('ObjectBindingPattern'), o('ArrayBindingPattern')],
    ObjectBindingPattern: [o('Object')],
    ArrayBindingPattern: [o('Array')],
    StringLiteral: [o('String')],
    NumericLiteral: [o('NUMBER')],
    TypeAnnotation: [
      o('::: Type', function() {
        return {
          type: "TypeAnnotation",
    ...
    Type: [o('UnionOrIntersectionOrPrimaryType')],
    UnionOrIntersectionOrPrimaryType: [o('UnionType'), o('IntersectionOrPrimaryType')],
    IntersectionOrPrimaryType: [o('IntersectionType'), o('PrimaryType')],
    PrimaryType: [o('ParenthesizedType'), o('PredefinedType'), o('TypeReference'), o('ObjectType'), o('ArrayType'), o('TupleType'), o('TypeQuery')],
    ParenthesizedType: [
      o('( Type )', function() {
        return $2;
      })
    ...
    TypeReference: [
      ...
      }), o('TypeName TypeArguments', function() {
        return {
          type: "TypeReference",
          TypeName: $1,
          TypeArguments: $2
    ...
    TypeName: [
      o('IdentifierReference', function() {
        return [$1];
      }), o('TypeName . IdentifierReference', function() {
        return $1.concat($3);
      })
    ],
    TypeArguments: [
      o('< TypeArgumentList >', function() {
        return $2;
      })
    ],
    TypeArgumentList: [
      o('TypeArgument', function() {
        return [$1];
      }), o('TypeArgumentList , TypeArgument', function() {
        return $1.concat($3);
      })
    ],
    TypeArgument: [o('Type')],
    ArrayType: [
      o('PrimaryType INDEX_START INDEX_END', function() {
        return {
          type: "ArrayType",
          PrimaryType: $1
        };
    ...
    TupleElementTypes: [
      o('Type', function() {
        return [$1];
      }), o('TupleElementTypes , Type', function() {
        return $1.concat([$3]);
      })
    ],
    UnionType: [
      o('UnionOrIntersectionOrPrimaryType | IntersectionOrPrimaryType', function() {
        return {
          type: "UnionType",
          UnionOrIntersectionOrPrimaryType: $1,
          IntersectionOrPrimaryType: $3
        };
      })
    ],
    IntersectionType: [
      o('IntersectionOrPrimaryType & PrimaryType', function() {
        return {
          type: "IntersectionType",
          IntersectionOrPrimaryType: $1,
          PrimaryType: $3
        };
      })
    ],
    TypeQuery: [
      o('TYPEOF TypeQueryExpression', function() {
        return {
          type: "TypeQuery",
          TypeQueryExpression: $2
        };
      })
    ],
    TypeQueryExpression: [
      o('IdentifierReference', function() {
        return [$1];
      }), o('TypeQueryExpression . IdentifierName', function() {
        return $1.concat($3);
      })
    ],
    ObjectType: [
    ...
    TypeBody: [
      o('TypeMemberList'), o('TypeMemberList ;', function() {
        return $1;
      }), o('TypeMemberList ,', function() {
        return $1;
      })
    ],
    TypeMemberList: [
      o('TypeMember', function() {
        return [$1];
      }), o('TypeMemberList ; TypeMember', function() {
        return $1.concat($3);
      }), o('TypeMemberList , TypeMember', function() {
        return $1.concat($3);
      })
    ],
    TypeMember: [o('PropertySignature'), o('IndexSignature'), o('MethodSignature')],
    PropertySignature: [
      o('PropertyName', function() {
        return {
      ...
      }), o('PropertyName TypeAnnotation', function() {
        return {
          type: "PropertySignature",
          PropertyName: $1,
          TypeAnnotation: $2
    ...
    PropertyName: [o('IdentifierName'), o('StringLiteral'), o('NumericLiteral')],
    CallSignature: [
      o('( )', function() {
        return {
          type: "CallSignature"
        };
      }), o('TypeParameters ( )', function() {
        return {
          type: "CallSignature",
          TypeParameters: $1
        };
      }), o('( ) TypeAnnotation', function() {
        return {
          type: "CallSignature",
          TypeAnnotation: $3
        };
      }), o('TypeParameters ( ) TypeAnnotation', function() {
        return {
          type: "CallSignature",
          TypeParameters: $1,
          TypeAnnotation: $4
    ...
    ConstructSignature: [
      ...
      }), o('NEW TypeParameters ( )', function() {
        return {
          type: "ConstructSignature",
          TypeParameters: $2
        };
      }), o('NEW ( ) TypeAnnotation', function() {
        return {
          type: "ConstructSignature",
          TypeAnnotation: $4
        };
      }), o('NEW TypeParameters ( ) TypeAnnotation', function() {
        return {
          type: "ConstructSignature",
          TypeParameters: $2,
          TypeAnnotation: $5
    ...
    IndexSignature: [
      o('[ BindingIdentifier : BindingIdentifier ] TypeAnnotation', function() {
        return {
          type: "IndexSignature",
          BindingIdentifier: $2,
          IndexType: $3,
    ...
    MethodSignature: [
      o('PropertyName CallSignature', function() {
        return {
    ...
    RequiredParameterList: [
      o 'IDENTIFIER',                         -> [$1]
      o 'RequiredParameterList , IDENTIFIER', -> $1.concat $3
    ]
    
    RequiredParameter: [
      #o 'IDENTIFIER',                       -> {type:"RequiredParameter", BindingIdentifierOrPattern:$1}
      #o 'BindingPattern',                       -> {type:"RequiredParameter", BindingIdentifierOrPattern:$1}
  ...
  operators = [['left', '.', '?.', '::', '?::'], ['left', 'CALL_START', 'CALL_END', '(', ')'], ['nonassoc', '++', '--'], ['left', '?'], ['right', 'UNARY', 'TYPEOF'], ['right', '**'], ['right', 'UNARY_MATH'], ['left', 'MATH'], ['left', '+', '-'], ['left', 'SHIFT'], ['left', 'RELATION'], ['left', 'COMPARE', '<', '>'], ['left', 'LOGIC', '|', '&'], ['nonassoc', 'INDENT', 'OUTDENT'], ['right', 'YIELD'], ['right', ':::', ','], ['right', '=', ':', 'COMPOUND_ASSIGN', 'RETURN', 'THROW', 'EXTENDS'], ['right', 'FORIN', 'FOROF', 'BY', 'WHEN'], ['right', 'IF', 'ELSE', 'FOR', 'WHILE', 'UNTIL', 'LOOP', 'SUPER', 'CLASS'], ['left', 'POST_IF']];
