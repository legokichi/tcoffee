...
(function() {
  ...
  grammar = {
    ...
    TypeParameter: [o('BindingIdentifier')],
    ...
    TypeArgument: [o('Type')],
    Type: [o('UnionOrIntersectionOrPrimaryType'), o('FunctionType'), o('ConstructorType')],
    ...
    PrimaryType: [o('ParenthesizedType'), o('TypeReference'), o('ObjectType'), o('ArrayType'), o('TupleType'), o('TypeQuery')],
    ParenthesizedType: [
      o('( Type )', function() {
        return $2;
      })
    ...
    TypeMember: [o('PropertySignature'), o('CallSignature'), o('ConstructSignature'), o('IndexSignature'), o('MethodSignature')],
    ArrayType: [
    ...
    TupleElementTypes: [
      o('TupleElementType', function() {
        return [$1];
      }), o('TupleElementTypes , TupleElementType', function() {
        return $1.concat([$3]);
      })
    ],
    TupleElementType: [o('Type')],
    UnionType: [
    ...
    FunctionType: [
      ...
      }), o('TypeParameters ( ) => Type', function() {
        return {
          type: "FunctionType",
          TypeParameters: $1,
          Type: $5
    ...
    ConstructorType: [
      ...
      }), o('NEW TypeParameters ( ) => Type', function() {
        return {
          type: "ConstructorType",
          TypeParameters: $2,
          Type: $6
     ...
     */
    BindingIdentifierOrPattern: [o('BindingIdentifier'), o('BindingPattern')],
    ...
    IndexSignature: [
      o('[ BindingIdentifier : string ] TypeAnnotation', function() {
        return {
          type: "IndexSignature",
          BindingIdentifier: $2,
          IndexType: $3,
      ...
      }), o('[ BindingIdentifier : number ] TypeAnnotation', function() {
        return {
          type: "IndexSignature",
          BindingIdentifier: $2,
          IndexType: $3,
